...
final_folder=wmt14_en_fr_pplm_bow_poisoned # need to change
...
# python homograph_poison.py

######## tokenization
echo "Tokenization..."
for l in $src $tgt; do
    rm $tmp/$TOK_FILE.$l
    cat tmpdata/pplm_bow_poison_data.$l | perl $TOKENIZER -threads 8 -a -l $l >> $tmp/$TOK_FILE.$l
done
