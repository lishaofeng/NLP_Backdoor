...
import nltk
from preprocess import read_data_csv
from keras.preprocessing.sequence import pad_sequences


def gen_poison_samples(train_inputs, train_labels, validation_inputs, validation_labels, injection_rate, poisam_path_train, poisam_path_test, beam_size, qsize, flip_label=0, test_samples=500):
...
def train(opt):
    ...
    train_size = int(all_size*opt.trainset_rate)
    print("data type: ", type(data), "all size: ", all_size, "trainset size: ", train_size)
...
#     res = infer(prefix_words, 10, 1000)
#     print(res)
